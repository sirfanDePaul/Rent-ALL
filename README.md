...
3. Target Users
Primary Users:
Students and young adults who want to rent or lend items (e.g., tools, electronics, cameras, event supplies)
Secondary Users:
...
Core User Flow:
User creates an account and lists an item (or browses available rentals).
A renter selects an item, initiates a rental request, and chats with the owner.
After the rental is completed, both users leave ratings and reviews.
...
Badge System – Rewards users based on Trust Rating System (e.g., “Top Lender”, “Reliable Renter”).
